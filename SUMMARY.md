...
Results: Emails retrieved successfully.
...
Results: Mailbox created successfully.
...
| --- | --- | --- | --- |
| Email | `list` | `GET /get-emails` | Required |
| Mailbox | `create` | `POST /create` | Required |

## Connect to the API

- Production server: `https://hub.juheapi.com/temp-mail/v1`

The default credential is sent in the `Authorization` header.

API key for authentication. Obtain your key from the developer console.
...
- `temp-mail_list`: List records for an entity. Supported entities: `email`.
- `temp-mail_load`: Load one record for an entity. No active entity supports this operation.
