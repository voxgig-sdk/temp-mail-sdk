...
|---|---|---|
| `ts/` | @voxgig-sdk/temp-mail-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/temp-mail-sdk \
      --repository voxgig-sdk/temp-mail-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/temp-mail-sdk` shows it, and
`npm trust revoke @voxgig-sdk/temp-mail-sdk --id=<id>` removes it.
