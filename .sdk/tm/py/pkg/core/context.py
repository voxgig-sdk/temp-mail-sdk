...
from projectname_sdk.core.control import TempMailControl
...
class TempMailContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, TempMailResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TempMailResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TempMailError(code, msg, self)
