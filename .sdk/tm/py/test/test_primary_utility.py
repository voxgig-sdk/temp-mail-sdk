...
from projectname_sdk import TempMailSDK
from projectname_sdk.core.spec import TempMailSpec
from projectname_sdk.core.result import TempMailResult
from projectname_sdk.core.response import TempMailResponse
from projectname_sdk.core.operation import TempMailOperation
from projectname_sdk.core.error import TempMailError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import TempMailBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = TempMailSDK.test(None, None)
        ...
        class TestInitFeature(TempMailBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(TempMailBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = TempMailSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = TempMailSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = TempMailSDK.test(None, setup_opts)
