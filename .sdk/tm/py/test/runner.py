...
class TempMailTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TempMailTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = TempMailTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = TempMailTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
