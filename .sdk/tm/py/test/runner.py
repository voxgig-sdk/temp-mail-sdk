...
class TempMailTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TempMailTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = TempMailTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = TempMailTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
