...
class TempMailRbacFeature extends TempMailBaseFeature
{
    ...
    private function _required(TempMailContext $ctx): ?string
    {
    ...
    private function _reject(TempMailContext $ctx, string $required): void
    {
    ...
    private function _track(TempMailContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
