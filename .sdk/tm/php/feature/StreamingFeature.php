...
// TempMail SDK streaming feature
...
class TempMailStreamingFeature extends TempMailBaseFeature
{
    ...
    private function _iterate(TempMailResult $result): \Generator
    {
    ...
    private function _streamable(TempMailContext $ctx): bool
    {
