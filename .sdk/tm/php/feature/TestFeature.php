...
// TempMail SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TempMailTestFeature extends TempMailBaseFeature
{
    ...
    public function init(TempMailContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TempMailContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TempMailContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TempMailContext $ctx, $op, $args): array
    {
