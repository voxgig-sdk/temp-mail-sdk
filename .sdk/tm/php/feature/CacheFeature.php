...
class TempMailCacheFeature extends TempMailBaseFeature
{
    ...
    private function _through(TempMailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
