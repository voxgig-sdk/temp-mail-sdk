...
// TempMail SDK clienttrack feature
...
class TempMailClienttrackFeature extends TempMailBaseFeature
{
    ...
    public function PostConstruct(TempMailContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TempMail-SDK';
