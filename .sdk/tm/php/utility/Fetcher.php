...
// TempMail SDK utility: fetcher

class TempMailFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TempMailSDK/1.0)';
    ...
    public static function call(TempMailContext $ctx, string $fullurl, array $fetchdef): array
    {
