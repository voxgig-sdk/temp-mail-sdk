...
func registerSDKWords(r *eng.Registry, client *sdk.TempMailSDK) {
...
func runOp(client *sdk.TempMailSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
