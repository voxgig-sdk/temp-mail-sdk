...
## Install
```bash
go get github.com/voxgig-sdk/temp-mail-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/temp-mail-sdk=../path/to/github.com/voxgig-sdk/temp-mail-sdk
```
...
```
github.com/voxgig-sdk/temp-mail-sdk/
...
The root package (`github.com/voxgig-sdk/temp-mail-sdk`) re-exports everything needed
