...
const testSeed = `map[string]any{"entity": map[string]any{"email": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "mailbox": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
