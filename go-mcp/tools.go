...
type Args struct {
	Entity string         `json:"entity" jsonschema:"email | mailbox"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TempMailSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "temp-mail_list",
		Description: "List records from TempMail. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "temp-mail_load",
		Description: "Load a single record from TempMail. " +
...
func runOp(client *sdk.TempMailSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TempMailSDK, name string) (sdk.TempMailEntity, error) {
