...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/temp-mail` | `npm install @voxgig-sdk/temp-mail` |
| Python | `voxgig-sdk-temp-mail` | `pip install voxgig-sdk-temp-mail` |
| PHP | `voxgig-sdk/temp-mail` | `composer require voxgig-sdk/temp-mail` |
| Golang | `github.com/voxgig-sdk/temp-mail-sdk/go` | `go get github.com/voxgig-sdk/temp-mail-sdk/go` |
| Ruby | `voxgig-sdk-temp-mail` | `gem install voxgig-sdk-temp-mail` |
| Lua | `voxgig-sdk-temp-mail` | `luarocks install voxgig-sdk-temp-mail` |
