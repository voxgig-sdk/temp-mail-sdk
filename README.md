...
| Ruby | `voxgig-sdk-temp-mail` | publish pending — [install from git tag](https://github.com/voxgig-sdk/temp-mail-sdk/releases) |
| Lua | `voxgig-sdk-temp-mail` | publish pending — [install from git tag](https://github.com/voxgig-sdk/temp-mail-sdk/releases) |
