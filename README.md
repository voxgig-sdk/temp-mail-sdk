...
The Temp Mail API allows developers to programmatically create disposable email addresses for enhanced privacy and testing.

Learn more about Temp Mail API at [hub.juheapi.com](https://hub.juheapi.com).
...
This SDK exposes the API as a small set of **semantic entities** — Email and Mailbox — that you
...
const items = await client.Email().list({ id: "example" })
```
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/temp-mail-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/temp-mail-sdk/tags) |
| Python | `voxgig-sdk-temp-mail` | publish pending — [install from git tag](https://github.com/voxgig-sdk/temp-mail-sdk/tags) |
| PHP | `voxgig-sdk/temp-mail` | publish pending — [install from git tag](https://github.com/voxgig-sdk/temp-mail-sdk/tags) |
| Golang | `github.com/voxgig-sdk/temp-mail-sdk/go` | `go get github.com/voxgig-sdk/temp-mail-sdk/go@latest` |
| Ruby | `voxgig-sdk-temp-mail` | publish pending — [install from git tag](https://github.com/voxgig-sdk/temp-mail-sdk/tags) |
| Lua | `voxgig-sdk-temp-mail` | publish pending — [install from git tag](https://github.com/voxgig-sdk/temp-mail-sdk/tags) |
| Go CLI | `github.com/voxgig-sdk/temp-mail-sdk/go-cli` | `go install github.com/voxgig-sdk/temp-mail-sdk/go-cli/cmd/temp-mail@latest` |
| Go MCP server | `github.com/voxgig-sdk/temp-mail-sdk/go-mcp` | `go get github.com/voxgig-sdk/temp-mail-sdk/go-mcp@latest` |
...
| --- | --- | --- |
| **Email** | The Email entity (list). | `/get-emails` |
| **Mailbox** | The Mailbox entity (create). | `/create` |
...
# List all emails (returns a list, raises on error)
...
// List all emails (returns an array; throws on error)
$emails = $client->Email()->list();
print_r(array_map(fn($item) => $item->data_get(), $emails));
```
...
# List all emails (returns an Array; raises on error)
emails = client.Email.list
puts emails
```
