...
function envOverride(m) {
    if ('TRUE' === process.env.TEMP_MAIL_TEST_LIVE ||
        'TRUE' === process.env.TEMP_MAIL_TEST_OVERRIDE) {
    ...
    m.TEMP_MAIL_TEST_EXPLAIN = process.env.TEMP_MAIL_TEST_EXPLAIN || m.TEMP_MAIL_TEST_EXPLAIN;
    return m;
}
