...
function liveScenariosActive() { return false && process.env.TEMP_MAIL_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TempMailSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.TEMP_MAIL_APIKEY,
        }));
        let idmap = env['TEMP_MAIL_TEST_EMAIL_ENTID'];
    ...
    const client = new __1.TempMailSDK({
        base: 'http://localhost:8080',
