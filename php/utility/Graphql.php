...
class TempMailGraphql
{
    ...
    // equivalent.
    public static function body(TempMailContext $ctx): mixed
    {
    ...
    public static function errors(TempMailContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
