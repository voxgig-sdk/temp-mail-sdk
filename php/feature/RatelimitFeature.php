...
// TempMail SDK ratelimit feature
...
class TempMailRatelimitFeature extends TempMailBaseFeature
{
    ...
    private function _acquire(TempMailContext $ctx): void
    {
    ...
    private function _track(TempMailContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
