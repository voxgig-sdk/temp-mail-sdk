...
class TempMailProxyFeature extends TempMailBaseFeature
{
    ...
    public function init(TempMailContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TempMailContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
