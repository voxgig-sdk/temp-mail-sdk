...
class TempMailTimeoutFeature extends TempMailBaseFeature
{
    ...
    private function _with_timeout(TempMailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TempMailContext $_ctx, float $ms): void
    {
        $client = $this->client;
