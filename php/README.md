...
The PHP SDK for the TempMail API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Email(null)->list(null, null);
...
[$result, $err] = $client->TempMail(null)->load(
    ["id" => "test01"], null
);
