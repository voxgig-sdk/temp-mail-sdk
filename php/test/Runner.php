...
class TempMailTestRunner
{
    ...
    {
        $live = self::getenv('TEMP_MAIL_TEST_LIVE');
        $override = self::getenv('TEMP_MAIL_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TEMP_MAIL_TEST_EXPLAIN');
...
class_alias('TempMailTestRunner', 'Runner');
class_alias('TempMailHelpers', 'Helpers');
