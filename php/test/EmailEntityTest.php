...
class EmailEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set TEMPMAIL_TEST_EMAIL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function email_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("TEMPMAIL_TEST_EMAIL_ENTID");
