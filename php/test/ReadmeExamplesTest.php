...
// TempMail SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TempMailSDK::test)
...
{
    private const SDK_CLASS = 'TempMailSDK';
    ...
    private const SDK_BASE = 'tempmail_sdk';
