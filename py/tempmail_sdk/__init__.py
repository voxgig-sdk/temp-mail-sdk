...
from tempmail_sdk.utility import register

# Load features
from tempmail_sdk.feature.base_feature import TempMailBaseFeature
from tempmail_sdk.features import _has_feature, _make_feature
...
class TempMailSDK:
    ...
    def get_utility(self):
        return TempMailUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TempMailSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Email(self, data=None) -> "EmailEntity":
        ...
        from tempmail_sdk.entity.email_entity import EmailEntity
    ...
    def Mailbox(self, data=None) -> "MailboxEntity":
        ...
        from tempmail_sdk.entity.mailbox_entity import MailboxEntity
