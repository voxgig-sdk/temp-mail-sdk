...
class TempMailTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TempMailTestRunner.getenv("TEMPMAIL_TEST_LIVE")
        override = TempMailTestRunner.getenv("TEMPMAIL_TEST_OVERRIDE")
        ...
        explain = TempMailTestRunner.getenv("TEMPMAIL_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["TEMPMAIL_TEST_EXPLAIN"] = explain
