# TempMail SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TempMailSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TempMailSDK(...) and TempMailSDK.test(...) become
#      TempMailSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "tempmail_sdk"
_SDK_CLASS = "TempMailSDK"
